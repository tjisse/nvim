...
map('n', 'dn', ':lua vim.diagnostic.goto_next()<CR>', default_opts)
map('n', 'dN', ':lua vim.diagnostic.goto_prev()<CR>', default_opts)
map('n', 'dq', ':lua vim.diagnostic.set_qflist()<CR>', default_opts)
map('n', 'dl', ':lua vim.diagnostic.set_loclist()<CR>', default_opts)
